...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_path', type=str, default="/home/bzheng12/SemEval-Intimacy/data/twitter_train.csv", help='')
    parser.add_argument('--test_data_path', type=str, default="/home/bzheng12/SemEval-Intimacy/data/semeval_test.csv", help='')
    parser.add_argument('--save_path', type=str, default="/brtx/605-nvme2/bzheng12/regressor_checkpoints", help='')
    parser.add_argument('--prediction_path', type=str, default="/brtx/605-nvme2/bzheng12/regressor_predictions/", help='')
