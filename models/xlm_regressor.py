...
class MultiLingualModel(nn.Module):
    def __init__(self, model_name, DEVICE, add_linear=False):
        super().__init__()
        self.device = DEVICE
        self.tokenizer = AutoTokenizer.from_pretrained(model_name, model_max_length=128, cache_dir="/brtx/605-nvme2/bzheng12/lms/caches")
        self.model = AutoModel.from_pretrained(
            model_name, output_attentions=False, output_hidden_states=False, cache_dir="/brtx/605-nvme2/bzheng12/lms/caches"
        ).to(DEVICE)
